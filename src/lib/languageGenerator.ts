...
export const defaultSettings: LanguageSettings = {
  mood: 'None', vocabularyInspirations: [], morphology: '', syllable: '', wordOrder: '', genderSystem: '', articleSystem: '', cases: [], regularity: 50, clusterPattern: '', vowelSequences: '', vowelHarmony: '', consonants: [], vowels: [], allowedInitials: [], allowedFinals: [],
}
