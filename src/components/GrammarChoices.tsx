...
export type GrammarKey = 'morphology' | 'syllable' | 'wordOrder' | 'genderSystem' | 'articleSystem' | 'clusterPattern' | 'vowelSequences' | 'vowelHarmony'
...
const labels: Record<GrammarKey, string> = {
  ...
  articleSystem: 'Articles', clusterPattern: 'Consonant clusters', vowelSequences: 'Vowel sequences', vowelHarmony: 'Vowel harmony',
}
